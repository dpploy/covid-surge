...
def main():
    ...
    # Plot the data
    us_surge.plot_covid_data( 'California' )
    ...
    # Fit data to model function
    param_vec = us_surge.fit_data( 'California' )
    print('')

    # Plot the fit data to model function
    us_surge.plot_covid_nlfit('California', param_vec )

    # Report critical times
    (tc,dtc) = us_surge.critical_times( 'California', param_vec )

    # Report errors 
    us_surge.error_analysis( 'California', param_vec, tc, dtc )
